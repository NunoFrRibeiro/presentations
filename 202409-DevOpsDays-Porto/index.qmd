...
__*[NunoFrRibeiro](https://github.com/NunoFrRibeiro) or Nuno Ribeiro*__

and for the better part of the last decade I was a Civil Engineer
...
![](./assets/thinking_meme.jpg){.r-stretch fig-align="center"}
...
I work as a DevOps Engineer @ [Cleva Solutions](https://cleva-solutions.com/)

but, __*only for today*__ I won't be talking about insurance
...
## {#push-and-pray background-color="black" background-transition="fade"}

::: {.center}
![](./assets/pushandpray.jpg)
:::
...
<h3>How does it solve this problem?</h3>

::: {.fragment .fade-up}
<h3>By running your pipelines in containers</h3>
:::
...
::: {.notes}
- To use Dagger, you call Dagger Functions. Functions are regular code, written in a supported programming language, that run in containers.
- Dagger Functions let you encapsulate common operations or workflows into discrete units with clear inputs and outputs.
- Functions are the fundamental unit of computing in Dagger
...
- The Dagger CLI is a easy to use tool that can be used interactively from a terminal or non-interactively from a shell script or a CI configuration.
- Dagger Functions can also be called from other Dagger Functions.
- Functions are packaged, shared and reused using modules.
...
::: {.notes}
- dagger supports multiple programming languages via native-language SDKs
:::
...
::: {.notes}
- enabling us to build our pipelines in the same language as our application and benefit from the ecosystem's existing tooling and best practices
:::
